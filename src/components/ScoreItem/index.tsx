          ...
          <View className={styles.item__lineup__result} onClick={() => viewDetail(scoreItem)}>
            {
              tabValue === 3 &&
              scoreItem.state === 8 &&
              scoreItem.aiResult !== null &&
              <Text className={`${styles.item__lineup__result__txt} ${scoreItem.aiResult === 0 ? styles.item__lineup__result__txt_grey : ''}`}>
                {
                  scoreItem.aiResult === 0 ? '否' : '中'
                }
              </Text>
            }
